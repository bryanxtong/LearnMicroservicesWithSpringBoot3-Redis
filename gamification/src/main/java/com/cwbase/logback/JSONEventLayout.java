...
public class JSONEventLayout extends LayoutBase<ILoggingEvent> {
	...
	String sourcePath;
	List<String> tags;
	List<com.cwbase.logback.AdditionalField> additionalFields;
	String type;
	...
	public synchronized String doLayout(ILoggingEvent event) {
		...
		if(additionalFields != null) {
			for(com.cwbase.logback.AdditionalField field : additionalFields) {
				buf.append(COMMA);
	...
	public void addAdditionalField(com.cwbase.logback.AdditionalField p) {
		if(additionalFields == null) {
